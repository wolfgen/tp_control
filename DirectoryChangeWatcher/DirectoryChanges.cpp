...
//
// Helper classes
class CPrivilegeEnabler;	 //for use w/ enabling process privileges when this code is first used. It's a singleton.
...
//
//	Enables user privileges to be set for this process.
//	
//	Process needs to have access to certain privileges in order
